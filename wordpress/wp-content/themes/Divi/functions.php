...
add_action ( 'woocommerce_single_product_summary', 'add_custom_text', 40 );
function add_custom_text() {
  echo '<span style="font-size:18px; color:#FCA13A; font-weight:bold; padding-top:25px; display:block;">Call 866-946-2676 to order today!</span>'; 
}